...
class SuccessorForest:
    ...
    visiting order (Section 4.3). The DFS timestamps and O(1)
    valid-interval structure built on top of this ordering live in
    ``dfs_interval.py``; this module only provides the raw forest.
    """
