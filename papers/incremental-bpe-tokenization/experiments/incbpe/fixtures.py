"""Shared ground-truth fixtures, notably the recovered Figure-2-variant
example. Lives inside the package (not under ``tests/``) because the
same data serves tests, benchmarks, and demos alike.

See ``papers/incremental-bpe-tokenization/notes/implementation-notes.md``
