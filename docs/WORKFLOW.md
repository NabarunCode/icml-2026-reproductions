...
| 4 | Implement | Our own reproduction code (not a copy of the reference implementation). |
| 5 | Benchmark | Rigorous, reproducible measurement per the benchmarking standard in the root README. |
...
| 7 | Trackio | Publish the reproduction as a Trackio logbook per the paper's challenge rules (see `trackio/README.md`). |
